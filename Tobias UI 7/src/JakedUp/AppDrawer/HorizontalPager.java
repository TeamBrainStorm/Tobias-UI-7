...
public final class HorizontalPager extends ViewGroup {
    ...
    public void setIndicators(LinearLayout pageIndicators) {

        this.indicatorsLayout = pageIndicators;
...
//                dot.setImageResource(R.drawable.pager_dot_selected);
//            } else {
//                dot.setImageResource(R.drawable.pager_dot_normal);
//            }
//
//            indicators.add(dot);
//            pageIndicators.addView(dot);
//        }

        if (Settings.show_indicators && Settings.autohide_indicators) {
            fadeOut = new AlphaAnimation(1, 0);

            fadeOut.setStartTime(500);
            fadeOut.setStartOffset(500);
            fadeOut.setDuration(500);

            indicatorsLayout.startAnimation(fadeOut);
...
//        final int homeButtonWidth = (int) (45 * displayMetrics.density + 0.5f);

        final int width = 600;//MeasureSpec.getSize(widthMeasureSpec);
    ...
    public boolean onTouchEvent(final MotionEvent ev) {
        ...
        if (Settings.show_indicators) {
            indicatorsLayout.clearAnimation();
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                try {
                    indicators.get(mCurrentScreen).setImageResource(R.drawable.pager_dot_normal);
                    indicators.get(mNextScreen).setImageResource(R.drawable.pager_dot_selected);
                    ...
                    e.printStackTrace();
                    try {
                        indicators.get(mCurrentScreen).setImageResource(R.drawable.pager_dot_selected);
                        indicators.get(mNextScreen).setImageResource(R.drawable.pager_dot_normal);
                    } catch (Exception e1) {
                        e1.printStackTrace();
                    }
                }
...
//            }
    ...
    public int removePage()
    {
        ...
        removeViewAt(num);
        indicators.remove(num);
        indicatorsLayout.removeViewAt(num);
